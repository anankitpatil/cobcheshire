...
<div class="container home">
  <div id="myCarousel" class="carousel slide mb24" data-ride="carousel"> 
    ...
    <div class="carousel-inner">
      <div class="item active"> <img src="images/slide_1.jpg" /> </div>
      <div class="item"> <img src="images/slide_2.jpg" /> </div>
      <div class="item"> <img src="images/slide_3.jpg" /> </div>
      <div class="item"> <img src="images/slide_4.jpg" /> </div>
      <div class="item"> <img src="images/slide_5.jpg" /> </div>
      <div class="item"> <img src="images/slide_6.jpg" /> </div>
      <div class="item"> <img src="images/slide_7.jpg" /> </div>
      <div class="item"> <img src="images/slide_8.jpg" /> </div>
      <div class="item"> <img src="images/slide_9.jpg" /> </div>
    </div>
    <!-- Carousel nav --> 
  ...
  <div class="row">
    <div class="col-lg-9 bodycopy justify">
      ...
      <p>The menu is constantly updated with dishes to tempt your taste buds and combine many talents of local suppliers to ensure we use the freshest and tastiest ingredients.</p>
      <p>The CoB has a fabulous private dining room which can host a number of events - weddings, birthdays, christenings, business meetings and much more.</p>
      <p>The outdoor space offers a superb relaxing area to enjoy a drink or two, dine al fresco or utilise for your event. Choose from our patio area or lawn and enjoy the beautiful countryside views.</p>
